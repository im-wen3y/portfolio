...
프로젝트 상세 화면, 인쇄 및 PDF 저장에 최적화된 이력서·포트폴리오 화면을 제공합니다.
루트 경로(`/`)는 `/resume`으로 이동합니다.

## 주요 화면

| 경로                      | 설명                                               |
| ------------------------- | -------------------------------------------------- |
| `/resume`                 | 경력, 기술, 소개를 담은 웹 이력서                  |
| `/portfolio`              | 게임형 인터랙션을 적용한 프로젝트 포트폴리오       |
| `/portfolio/project/[id]` | 개별 프로젝트 상세 내용                            |
| `/print`                  | 이력서·포트폴리오 전환, 색상 설정 및 PDF 저장      |
